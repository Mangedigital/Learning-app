  ...
  return (
    <div className="space-y-4 md:space-y-6">
      <div className="bg-blue-50 border-l-4 border-blue-500 p-4 md:p-6 rounded-r-xl">
        ...
        <p className="text-blue-900 leading-relaxed italic text-sm md:text-base">"{scenario}"</p>
      </div>
      ...
      <div>
        ...
        <textarea
          ...
          className="w-full h-32 md:h-40 p-3 md:p-4 border-2 border-slate-100 rounded-xl focus:border-[#004b89] focus:outline-none transition-all resize-none shadow-inner text-sm md:text-base"
        ></textarea>
      </div>
      ...
      {!feedback ? (
        <button
          ...
          className="w-full bg-[#004b89] text-white py-3 md:py-4 rounded-xl font-bold hover:bg-[#003d70] transition-all flex items-center justify-center gap-2 shadow-lg hover:-translate-y-0.5 text-sm md:text-base"
        >
          {loading ? (
        ...
        <div className="animate-in slide-in-from-bottom-4 duration-500">
          <div className="bg-[#004b89] text-white p-4 md:p-6 rounded-2xl shadow-xl mb-4 md:mb-6 relative overflow-hidden border border-blue-400">
            <div className="absolute top-0 right-0 p-4 opacity-10 hidden md:block">
              <i className="fa-solid fa-user-tie text-6xl"></i>
            </div>
            <h4 className="text-xs font-bold text-blue-200 uppercase tracking-widest mb-1 md:mb-2">AI-mentorns coachning</h4>
            <p className="text-base md:text-lg leading-relaxed relative z-10 font-medium">{feedback}</p>
          </div>
          <button
            onClick={() => onComplete(reflection)}
            className="w-full bg-green-600 text-white py-3 md:py-4 rounded-xl font-bold hover:bg-green-700 transition-all shadow-lg hover:-translate-y-0.5"
          >
