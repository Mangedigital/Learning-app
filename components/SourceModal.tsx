    ...
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-3 md:p-4 bg-slate-900/60 backdrop-blur-sm animate-in fade-in duration-300">
      <div className="bg-white w-full max-w-2xl rounded-2xl md:rounded-3xl shadow-2xl overflow-hidden flex flex-col max-h-[90vh]">
        <div className="bg-[#004b89] p-4 md:p-6 text-white flex justify-between items-center">
          ...
          <button onClick={onClose} className="hover:bg-white/10 p-1.5 md:p-2 rounded-full transition-colors">
            <i className="fa-solid fa-xmark text-lg md:text-xl"></i>
          </button>
        </div>
        <div className="p-5 md:p-8 overflow-y-auto">
          {clue && (
            <div className="bg-blue-50 border-l-4 border-[#004b89] p-4 md:p-6 rounded-r-xl mb-6 md:mb-8">
        ...
        <div className="p-4 md:p-6 bg-slate-50 border-t border-slate-100 text-center">
          <button onClick={onClose} className="w-full bg-[#004b89] text-white py-3.5 md:py-4 rounded-xl font-bold shadow-lg hover:bg-[#003d70] transition-all active:scale-95 text-sm md:text-base">
